...
def load_products():
      ...
      if not os.path.exists(PRODUCTS_FILE):
                initial_products = [
                              {"id": 1, "name": "Beko Frizider RCSA366K40WN", "my_price": 899.00, "link": "", "competitors": {}},
                              {"id": 2, "name": "Gorenje Masina za ves WEI843", "my_price": 749.00, "link": "", "competitors": {}},
                              ...
                              {"id": 5, "name": "Bosch Usisivac BGL3HYG", "my_price": 299.00, "link": "", "competitors": {}},
                              {"id": 6, "name": "LG Klima uredjaj S09ET", "my_price": 1199.00, "link": "", "competitors": {}},
                              ...
                              {"id": 10, "name": "Electrolux Sporet EKC6450", "my_price": 1099.00, "link": "", "competitors": {}}
                ]
  ...
  def save_products(products):
    ...
    for product in products:
              ...
              competitor_prices = [
                  c['price'] for c in            c['price'] for c in product['competitors'].values() 
